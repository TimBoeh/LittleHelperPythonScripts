        ...
        with open(cleaned_file_path, 'w') as cleaned_file:
            for line in original_content:
                if line.startswith(">"):
                    ...
                    sequence_name = line[1:]  ## Remove the double '>'
                    modified_name = sequence_name.split(" ", 1)[0]  ## Remove everything after first space
                    cleaned_file.write(">" + modified_name + "\n")
                else:
                    cleaned_file.write(line)

    print("Sample names have been cleaned and files saved in the 'cleanedSampNames' directory.")
